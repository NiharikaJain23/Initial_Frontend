...
<nav class="navbar main-nav border-less fixed-top navbar-expand-lg p-0">
  <div class="container-fluid p-0">
      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="speakers.html">Login/Register
            <span>/</span>
          </a>
        </li>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="block">
					...
					<h2>Contibute to NGO</h2>
					<h6>Serve Humanity! Feel Good</h6>
					<!-- Action Button -->
					<a href="#" class="btn btn-white-md">Book your Time now</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-6 align-self-center">
				<div class="content-block">
					<h2>About The <span class="alternate">CaresBridge’</span></h2>
					...
					<ul class="list-inline">
						<li class="list-inline-item">
							<a href="#" class="btn btn-main-md">Donate</a>
						</li>
						<li class="list-inline-item">
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="section-title white">
					<h3>Top <span class="alternate">NGOs</span></h3>
					<p>Some description here about these NGOs</p>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Smiles Foundation</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Prem Niketan</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Kala Vraksh</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Sanathun</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="images/speakers/speaker-five.jpeg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Agresain</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Grehalay</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="images/speakers/speaker-seven.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Kamal Niketan</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="images/speakers/speaker-eight.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="content text-center">
						<h5><a href="single-speaker.html">Safedi</a></h5>
						<p>More Details</p>
					</div>
				</div>
			</div>
				...
				<div class="registration-block bg-registration overlay-dark">
					<div class="block">
						<div class="title text-left">
							<h3>Register to <span class="alternate">CaresBridge</span></h3>
...
<section class="news section">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h3>CaresBridge<span class="alternate">News</span></h3>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusm tempor incididunt ut labore dolore</p>
				</div>
			</div>
		</div>
    ...
    <div class="row">
      <div class="col-md-6 align-self-center">
        <div class="copyright-text">
          <p><a href="#">CaresBridge</a> &#169; 2019 All Right Reserved</p>
        </div>
      </div>
      <div class="col-md-6">
